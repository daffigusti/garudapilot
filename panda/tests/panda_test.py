...
p.can_send(0x40f, b"\x01\x66\x01\x0a\x00\x00\x0f\xcc", 0)

p.can_send(0x537, b"\x03\x10\x00\x00\x11\x04\x00\x00", 0)
p.can_send(0x4f6, b"\x20\x01", 0)
p.can_send(0x4f6, b"\x40\x01", 0)
