...
class CarControllerParams:
  ...
  STEER_MAX = 200  # Safety limit, not LKA max. Trucks use 600.
  STEER_DELTA_UP = 3      # torque ramp up rate per frame, smoother transition
  STEER_DELTA_DOWN = 3    # torque ramp down rate per frame
